...
from keras.layers import Input, Lambda, Conv2D,SeparableConv2D, MaxPooling2D, BatchNormalization, ELU, Reshape, Concatenate, Activation
...
def build_model(image_size,
    ...
    conv1 = SeparableConv2D(3, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1')(x)
